...
def reparo(item_id):
    ...
    if request.method == "POST":
        ...
        c.execute("""
            UPDATE itens SET status=%s, solucao=%s, tipo_reparo_id=%s, valor_cobrado=%s
            WHERE id=%s
        """, (novo_status, solucao, tipo_id or None, valor_cobrado, item_id))
